...
public class CategoryController {
    ...
    public ResponseEntity<ProductDto> updateProduct(@PathVariable("categoryId") String categoryId, @PathVariable("productId") String productId, @RequestBody ProductDto productDto) {
        ProductDto productDto2 = productService.update(productDto, productId, categoryId);
        return ResponseEntity.status(HttpStatus.OK).body(productDto2);
    }
