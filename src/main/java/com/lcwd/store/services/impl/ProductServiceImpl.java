...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
	public ProductDto update(ProductDto dto, String productId, String categoryId) {
		Product prod = productRepository.findById(productId)
                .orElseThrow(() -> new RuntimeException("Product is not found"));
        ...
        Product prod1 = productRepository.findById(dto.getProductId()).orElseThrow(() -> new RuntimeException("Product is not found"));
        return map.map(prod1, ProductDto.class);
	}
